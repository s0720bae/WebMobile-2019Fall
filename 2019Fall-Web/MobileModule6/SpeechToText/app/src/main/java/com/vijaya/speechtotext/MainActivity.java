...
public class MainActivity extends AppCompatActivity {
    ...
    private void recognition(String text) {
        ...
        if (text.contains("not feeling good") || text.contains("should I do")) {
            speak("I can understand please tell me your symptoms in short");
        }
        if (text.contains("what medicine") || text.contains("should I take")) {
            speak("I think you have a cold, you should take some cough medicine");
        }
